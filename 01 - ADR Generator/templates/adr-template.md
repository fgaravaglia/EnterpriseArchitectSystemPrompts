...
Any additional links to other ADR if needed. This section is mandatory in case of Status 'Superseded. 
...
Track here the changes of status and other main updates to the record, using a table with columns:
